...
@Test func codeChallengeVerification() async throws {
    let verifier = "z34oHaauNSc13ScLRDmbQrJ5bIR9IDzRCWZTRRAPtlV"
    let code = RQESService.codeChallenge(for: verifier)
    #expect(code == "V4n5D1_bu7BPMXWsTulFVkC4ASFmeS7lHXSqIf-vUwI")
}
